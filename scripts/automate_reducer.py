...
def main():
    ...
    if ns.batch:
        ...
        run_reduction(reducer, compilers_dict, exec_dirs, ns.test_file, ns.output_file, ns.ref)



def batch_reduction(reducer, compilers, exec_dirs, files_to_reduce, ref, override_prefix="_reduced"):
...
def run_reduction(reducer, compilers, exec_dirs, test_input, test_output, ref):
    ...
    create_shell_test.build_shell_test(compilers, exec_dirs, "temp.shadertrap", reducer.input_file, ref, reducer.interesting_test)
